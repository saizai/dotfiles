# Ubuntu:
# sudo apt-get install git zsh powerline fonts-powerline zsh-theme-powerlevel9k zsh-syntax-highlighting
...
export ZSH="/Users/saizai/.oh-my-zsh"
...
# ssh
export SSH_KEY_PATH="~/.ssh/sai_new_ssh"
...
alias prune_dupes='~/GoogleDrive/workspace/utils/rm_dupes_from.rb --prune_dirs'
alias rm_empty_dirs="find -x -d . -type d -empty -print -delete"
alias rm_cruft='find -E -d . -regex "(^|.*/)(Icon|\.DS_Store|desktop\.ini)[[:space:][:blank:][:cntrl:][:punct:]_?]*[^[:print:]]*$" -print -delete'
...
alias ls="ls --color --almost-all --author --escape --classify --group-directories-first --human-readable  --time-style=long-iso --quoting-style=shell-escape" # --hyperlink=auto
